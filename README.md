...
- **Easy2Tech (2022–2023)** → Automação de dados financeiros (CRA, CRI, Debêntures) com tecnologias modernas.  
- **CT Boas Novas (2023–2024)** → Desenvolvimento e manutenção de site institucional com **HTML, CSS, JS e Sass**.  
- **Freelancer (2015–2024)** → Projetos de FrontEnd e BackEnd, suporte técnico e soluções digitais.  
- Portfólio: [brunodallagnol.com](https://brunodallagnol.com)
...
- 🌱 Aprimorando habilidades em **JavaScript, SQL, React e Python**.  
- 💬 Pergunte-me sobre desenvolvimento web, boas práticas de programação e análise de dados.  
- ⚡ Curiosidade: Minha extroversão fortalece o trabalho em equipe e a colaboração.  
...
[![Portfólio](https://img.shields.io/badge/Portfólio-brunodallagnol.com-30A3DC?style=for-the-badge)](https://brunodallagnol.com)  
